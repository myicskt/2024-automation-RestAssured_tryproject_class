...
public class CreateOneAccount extends GenerateBeareToken {
	...
	public CreateOneAccount() {
		...
		redallOneEndPoint = PropertyReader.getProperty("create_ENdPoint");
	...
	public void readAllAccount() {
		...
		Response responce =
				...
				given().baseUri(baseURI).header("Content-Type", "application/json")
						...
						.auth().preemptive().basic("demo1@codefios.com ", "abc123").queryParam("account_id", "416")

						.when().get(redallOneEndPoint).then()
						// .log().all()
						.extract().response()
		...
		/*
		 ...
		 "account_id": "416", "account_name": "gg NEW Techfios account 111",
		 "account_number": "123456789", "descrsiption": "Test description 1",
